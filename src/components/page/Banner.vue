  ...
  data() {
    return {
      BannerList: [
        {
          id: 1,
          imgSrc: require("../../assets/banner1.jpg"),
          title: "蛮犀科技,创建智慧安全生活",
        ...
        {
          id: 3,
          imgSrc: require("../../assets/banner15.jpg"),
          title: "APP信息安全生态闭环",
          text: "事前预警 事中可防护 事后可追溯"
        },
        {
          id: 4,
          imgSrc: require("../../assets/nav4.png"),
          title: "隐私合规专项检查 满足监管要求",
          text: ""
        }
      ]
    };
...
.el-carousel .el-carousel__item p {
  font-size: 18px;
  letter-spacing: 1px;
  line-height: 35px;
  margin: 10px 0px 0px 10px;
}
.el-carousel .el-carousel__item:nth-of-type(3) p {
  margin-left: 0;
}
